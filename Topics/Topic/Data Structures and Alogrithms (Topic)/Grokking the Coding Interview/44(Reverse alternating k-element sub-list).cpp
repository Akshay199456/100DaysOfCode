...
/*
-------------------------    Notes
problem follows in-place reversal of a linked list pattern and quite similar to Reverse every k-element 
sub-list. only difference is that we have to sjip 'k' alternating elements. can follows
similar appraich, and in each iteration after reversing 'k' elements, we will skip the next k elements
*/
