...
/*
-------------------------    Notes
follows merge intervals patterns and can eaasil be converted to minimum meeting rooms problem.
for max cpu load, we need to find the max number of jobs runnoing at any time. will need to keep a running
count of max cpu load at any time to find overall max load
*/
